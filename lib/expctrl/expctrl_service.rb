...
public
  ...
  #----to create a new experiment we initialize some variables like
  #----"experiment_number" and make sure that this number is unique
  def create_experiment
    experiment = ExpCtrlExperiment::new
    #----response is just a hash
    response = CreateExperimentResponse::new
    #----we add a new pair to hash
